...
package com.groksolutions.grok.mobile.tutorial;
...
public class TutorialActivity extends FragmentActivity {
    ...
    private final BroadcastReceiver _metricChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            // Cache last metric change event while tutorial is active
            _instances = intent.getIntExtra(GrokDataSyncService.EXTRA_NEW_INSTANCES, 0);
            _metrics = intent.getIntExtra(GrokDataSyncService.EXTRA_NEW_METRICS, 0);
            _remaining = intent.getIntExtra(GrokDataSyncService.EXTRA_REMAINING_TIME, 0);
        }
    };
