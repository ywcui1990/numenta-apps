...
public class GrokClientImpl implements GrokClient {
    ...
    @Deprecated
    public static final Version GROK_SERVER_1_1 = new Version("1.1");
    @Deprecated
    public static final Version GROK_SERVER_1_2 = new Version("1.2");

    public static final Version GROK_SERVER_1_3 = new Version("1.3");
    public static final Version GROK_SERVER_1_4 = new Version("1.4");
    public static final Version GROK_SERVER_1_5 = new Version("1.5");
    public static final Version GROK_SERVER_1_6 = new Version("1.6");
    ...
    /**
     * Construct Grok API client to the the given server.
     *
    ...
    private void getMetricDataAsync(String modelId, Date from, Date to,
        ...
        try {
            ...
            // Check for Authentication and other Grok errors
    ...
    private InputStream getStream(String url) throws IOException, GrokException {
        ...
        try {
            ...
            // Check for Authentication and other Grok errors and throw new
            // Exception.
            handleHttpError(connection, ex);
        }
        return null;
    ...
    /**
     * Handles Grok Server response codes.
     * <p>
