...
import com.groksolutions.grok.mobile.dialog.RefreshDialogFragment;
import com.groksolutions.grok.mobile.instance.InstanceListActivity;
import com.groksolutions.grok.mobile.notification.NotificationListActivity;
import com.groksolutions.grok.mobile.preference.PreferencesConstants;
import com.groksolutions.grok.mobile.preference.SettingsActivity;
...
import static com.groksolutions.grok.mobile.preference.PreferencesConstants.PREF_LAST_CONNECTED_TIME;

/**
 * <p>
 * Base activity showing a common menu and handle all other common functions of a typical Grok Activity.
 * All other Grok activities must inherit from this class.
...
public class GrokActivity extends FragmentActivity {
    ...
    private final BroadcastReceiver _authenticationFailedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent = new Intent(GrokActivity.this, LoginActivity.class);
    ...
    private final BroadcastReceiver _metricChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            int instances = intent.getIntExtra(GrokDataSyncService.EXTRA_NEW_INSTANCES, 0);
            int metrics = intent.getIntExtra(GrokDataSyncService.EXTRA_NEW_METRICS, 0);
            if (metrics > 0) {
                ...
                // Show message
                Toast.makeText(GrokActivity.this, title, Toast.LENGTH_LONG).show();
            }
        }
    };
                ...
                builder.setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                GrokActivity.this.emailFeedback(null);
                            }
                        }
                );
