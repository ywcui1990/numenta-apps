 ...
 */
public class AnnotationListActivity extends GrokActivity {
     ...
     */
    public static final String EXTRA_TIMESTAMP = "com.groksolutions.grok.mobile.annotation.timestamp";
    /**
     * The {@link com.groksolutions.grok.mobile.instance.InstanceAnomalyChartData} for the instance
     * containing the annotations. The instance chart data must be preloaded.
     *
     * @see com.groksolutions.grok.mobile.instance.InstanceAnomalyChartData#load()
     */
    public static final String EXTRA_INSTANCE_DATA = "com.groksolutions.grok.mobile.annotation.instanceData";
     ...
     * Open {@link com.groksolutions.grok.mobile.annotation.AddAnnotationActivity} for the current
