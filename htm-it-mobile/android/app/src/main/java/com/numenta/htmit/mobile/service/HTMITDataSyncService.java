...
import static com.numenta.htmit.mobile.preference.PreferencesConstants.PREF_DATA_REFRESH_RATE;
 ...
 */
public class HTMITDataSyncService extends DataSyncService {

    private static final String TAG = HTMITDataSyncService.class.getSimpleName();
    ...
    public HTMITDataSyncService(DataService service) {
        super(service);
    }
    ...
    /**
     * Load all instances from server and update the local database by adding new instances and
    ...
    @Override
    protected HTMITClientImpl getClient() {
