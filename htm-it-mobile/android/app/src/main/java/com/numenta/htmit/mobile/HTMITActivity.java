...
import com.numenta.htmit.mobile.dialog.RefreshDialogFragment;
import com.numenta.htmit.mobile.instance.InstanceListActivity;
import com.numenta.htmit.mobile.notification.NotificationListActivity;
import com.numenta.htmit.mobile.preference.PreferencesConstants;
import com.numenta.htmit.mobile.preference.SettingsActivity;
...
import static com.numenta.htmit.mobile.preference.PreferencesConstants.PREF_LAST_CONNECTED_TIME;

/**
 * <p>
 * Base activity showing a common menu and handle all other common functions of a typical HTM-IT
 * Activity. All other activities must inherit from this class.
...
public class HTMITActivity extends FragmentActivity {
    ...
    private final BroadcastReceiver _authenticationFailedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent = new Intent(HTMITActivity.this, LoginActivity.class);
    ...
    private final BroadcastReceiver _metricChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            int instances = intent.getIntExtra(HTMITDataSyncService.EXTRA_NEW_INSTANCES, 0);
            int metrics = intent.getIntExtra(HTMITDataSyncService.EXTRA_NEW_METRICS, 0);
            if (metrics > 0) {
                ...
                // Show message
                Toast.makeText(HTMITActivity.this, title, Toast.LENGTH_LONG).show();
            }
        }
    };
                ...
                builder.setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                HTMITActivity.this.emailFeedback(null);
                            }
                        }
                );
    ...
    private Uri takeScreenCapture(boolean isRetryOk) {
        String fileName = "HTMIT_" + new SimpleDateFormat(
                "yyyyMMddhhmm'.jpg'",
