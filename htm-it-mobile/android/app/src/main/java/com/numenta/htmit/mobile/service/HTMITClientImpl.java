...
/**
 * <code>HTMClient</code> class wraps a connection to the HTM-IT REST API
 */
public class HTMITClientImpl implements HTMClient {
    @Deprecated
    public static final Version SERVER_1_0 = new Version("1.0");
    @Deprecated
    public static final Version SERVER_1_1 = new Version("1.1");
    @Deprecated
    public static final Version SERVER_1_2 = new Version("1.2");

    public static final Version SERVER_1_3 = new Version("1.3");
    public static final Version SERVER_1_4 = new Version("1.4");
    public static final Version SERVER_1_5 = new Version("1.5");
    public static final Version SERVER_1_6 = new Version("1.6");
    public static final Version SERVER_OLDEST = SERVER_1_3;
    public static final Version SERVER_LATEST = SERVER_1_6;

    private static final String TAG = HTMITClientImpl.class.getSimpleName();
    ...
    private Version _serverVersion = SERVER_OLDEST;
    /**
    ...
    /**
     * Construct HTM-IT API client to the the given server.
     *
     ...
     */
    public HTMITClientImpl(String serverUrl, String password)
            throws MalformedURLException {
    ...
    private void getMetricDataAsync(String modelId, Date from, Date to,
        ...
        try {
            ...
            // Check for Authentication and other errors
    ...
    public List<Annotation> getAnnotations(Date from, Date to) throws HTMException, IOException {
        ...
        if (_serverVersion.compareTo(SERVER_1_6) < 0) {
            return null;
        }
    ...
    public Annotation addAnnotation(Date timestamp, String server, String message, String user) throws
        ...
        try {
            // Prepare 'Add Annotation' request. See HTM-IT API for reference.
    ...
    protected HttpURLConnection openConnection(String url, String method) throws IOException {
        ...
        connection.setRequestProperty("X-HTMIT-DeviceId", HTMITApplication.getDeviceId());
        return connection;
    }
    ...
    private InputStream getStream(String url) throws IOException, HTMException {
        ...
        try {
            ...
            // Check for Authentication and other errors and throw new
            // Exception.
            handleHttpError(connection, ex);
        }
        return null;
