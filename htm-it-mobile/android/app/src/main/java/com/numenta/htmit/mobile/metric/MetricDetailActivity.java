...
package com.numenta.htmit.mobile.metric;

import com.google.android.gms.analytics.HitBuilders;
import com.google.android.gms.analytics.Tracker;

import com.numenta.htmit.mobile.HTMITApplication;
import com.numenta.htmit.mobile.HourDayWeekActivity;
...
public class MetricDetailActivity extends HourDayWeekActivity {
    ...
    public static final String EXTRA_METRIC = "com.numenta.htmit.mobile.metric";

    public static final String EXTRA_DATE = "com.numenta.htmit.mobile.metric.date";
    ...
    /*
     * (non-Javadoc)
     * @see com.numenta.htmit.mobile.BaseActivity#getResourceView()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.numenta.htmit.mobile.BaseActivity#createTabFragment(android.
     * app.ActionBar.Tab)
     */
    @Override
    ...
    private void submitUserFeedbackAsync() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                String uploadId = uploadFeedbackData();
                if (uploadId == null) {
    ...
    /**
     * Request HTM-IT API to upload feedback data for the user feedback feature
     * <p>
     ...
     */
    private String uploadFeedbackData() {
        String uploadId;

        // Connect to htmit
        HTMITClientImpl client = null;
        ...
        if (serverUrl != null) {
            ...
            try {
                client = (HTMITClientImpl) HTMITApplication.getInstance().connectToServer(serverUrl, password);
                client.login();
            ...
            Log.e(TAG, "Unable to connect to server. Missing server URL.");
        }
        ...
        // Send the request to htmit
        try {
            uploadId = client.post(serverUrl + "/_logging/feedback", request.toString());
        } catch (Exception e) {
            Log.e(TAG, "HTM-IT _logging/feedback request failed.", e);
     ...
     * (non-Javadoc)
     * @see
     * com.numenta.htmit.mobile.HourDayWeekActivity#onTabSelected(android
