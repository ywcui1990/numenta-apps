...
public class InstanceAnomalyChartData implements AnomalyChartData, Serializable {
    ...
    public InstanceAnomalyChartData(String instanceId,
        ...
        this._name = database.getServerName(_instanceId);
    ...
    public boolean load() {
        ...
        try {
            ...
            if (_endDate <= 0) {
                _endDate = database.getLastTimestamp();
            }
            _data = database.getAggregatedScoreByInstanceId(_instanceId,
    ...
    public boolean loadAnnotations() {
        ...
        try {
            ...
            // Load Annotations
            Collection<Annotation> result = database.getAnnotations(_instanceId, null, new Date(
                    _endDate));
            long newValues[] = null;
