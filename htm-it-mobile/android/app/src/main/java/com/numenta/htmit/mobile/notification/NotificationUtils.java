...
package com.numenta.htmit.mobile.notification;

import com.numenta.htmit.mobile.HTMITApplication;
import com.numenta.htmit.mobile.data.HTMITDatabase;
import com.numenta.htmit.mobile.metric.MetricDetailActivity;
...
public class NotificationUtils extends com.numenta.core.utils.NotificationUtils {
    ...
    static final class NotificationAsyncTask extends AsyncTask<Void, Void, Intent> {
        ...
        protected Intent doInBackground(Void... voids) {
            final HTMITDatabase database = HTMITApplication.getDatabase();
            Notification notification = database.getNotificationByLocalId(notificationId);
