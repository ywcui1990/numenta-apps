...
package com.numenta.htmit.mobile.data;
 ...
 * {@inheritDoc}
 *
 * Extends <b>mobile-core</b> database with <b>htmit</b> specific API
 */
public class HTMITDatabase extends CoreDatabaseImpl {

    public static final int HTMIT_DATABASE_VERSION = 0;
    ...
    private static final String TAG = HTMITDatabase.class.getSimpleName();
    ...
    public HTMITDatabase(Context context) {
        super(context, new HTMITDataFactoryImpl());
    }
    ...
    public int getVersion() {
        return HTMIT_DATABASE_VERSION * 1000 + super.getVersion();
    }
