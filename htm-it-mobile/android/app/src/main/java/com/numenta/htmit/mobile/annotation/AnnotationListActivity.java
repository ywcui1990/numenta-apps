...
package com.numenta.htmit.mobile.annotation;
...
import com.numenta.htmit.mobile.HTMITActivity;
import com.numenta.htmit.mobile.R;
import com.numenta.core.ui.chart.AnomalyChartView;
import com.numenta.htmit.mobile.instance.InstanceAnomalyChartData;
import com.numenta.htmit.mobile.instance.InstanceAnomalyChartFragment;
 ...
 */
public class AnnotationListActivity extends HTMITActivity {
     ...
     */
    public static final String EXTRA_TIMESTAMP = "com.numenta.htmit.mobile.annotation.timestamp";
    /**
     * The {@link com.numenta.htmit.mobile.instance.InstanceAnomalyChartData} for the instance
     * containing the annotations. The instance chart data must be preloaded.
     *
     * @see com.numenta.htmit.mobile.instance.InstanceAnomalyChartData#load()
     */
    public static final String EXTRA_INSTANCE_DATA = "com.numenta.htmit.mobile.annotation.instanceData";
     ...
     * Open {@link com.numenta.htmit.mobile.annotation.AddAnnotationActivity} for the current
