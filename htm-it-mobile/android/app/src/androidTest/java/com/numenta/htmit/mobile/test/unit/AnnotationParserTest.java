...
import com.numenta.htmit.mobile.service.AnnotationParser;
    ...
    public void testParse() throws Exception {
        ...
        try {
            ...
            Annotation expected = factory.createAnnotation("f90057f34e53425194f90794e289fee4",
                    ...
                    "us-west-2/AWS/ELB/htmit-docs-elb", "My Demo Message", null);

            // Sample annotation file with 3 annotations
            InputStream in = getTestData(HTMITClientImpl.SERVER_1_6, "annotation.json");
