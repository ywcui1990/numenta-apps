...
package com.numenta.htmit.mobile.test.behavior;
...
public class MobileAppTest {
    ...
    static By ANOMALIES = By
            .id("com.numenta.htmit.mobile:id/sortByAnomalies");
    static By NAME = By.id("com.numenta.htmit.mobile:id/sortByName");
    static By HOUR = By.name("HOUR");
    static By DAY = By.name("DAY");
    static By WEEK = By.name("WEEK");
    static By EXIT_TUTORIAL = By
            .id("com.numenta.htmit.mobile:id/skipTutorialButton");
    static By SKIP_TUTORIAL = By
            .id("com.numenta.htmit.mobile:id/skipTutorialButton");
    static By INSTANCE = By
            .id("com.numenta.htmit.mobile:id/instance_anomaly_chart");
    static By NOTIFICATION = By
            .id("com.numenta.htmit.mobile:id/menu_notifications");
    static By CLOSE_BUTTON = By
            .id("com.numenta.htmit.mobile:id/action_close_notifications");
    static By DATE = By.id("com.numenta.htmit.mobile:id/date");
    ...
    static By LABEL_SORTEDBY = By
            .id("com.numenta.htmit.mobile:id/sortTitleText");
    static By ADD_ANOTATION_POP_UP = By.name("Add Annotation");
    static By ANOTATION_NAME = By
    		.id("com.numenta.htmit.mobile:id/txt_name");
    static By ANOTATION_DESCRIPTION = By
            .id("com.numenta.htmit.mobile:id/txt_annotation_message");
    static By ANOTATION_SAVE_BUTTON = By
            .id("com.numenta.htmit.mobile:id/btn_save_annotation");
    static By ANOTATION_DELETE_BUTTON = By
            .id("com.numenta.htmit.mobile:id/btn_annotation_delete");
    ...
    public void setUp(String deviceName, String platformVersion,
        ...
        capabilities.setCapability("name", "HTM-IT mobile Testing");
        capabilities.setCapability("app",
                "sauce-storage:htm-it-mobile-app-release.apk");
        capabilities.setCapability("platformName", "Android");
        capabilities.setCapability("device-orientation", "portrait");
        capabilities.setCapability("deviceName", deviceName);
        capabilities.setCapability("platformVersion", platformVersion);
        capabilities.setCapability("androidPackage",
                "com.numenta.htmit.mobile");
        capabilities.setCapability("appActivity",
                "com.numenta.htmit.mobile.SplashScreenActivity");
