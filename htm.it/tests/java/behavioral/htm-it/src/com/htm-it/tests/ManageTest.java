...
public class ManageTest {
    ...
    public static void manageInstancesCurrentlyMonitoredByHTM-ITSectionVerification(
            WebDriver driver) {
        ReusableTests
                .testInstancesCurrentlyMonitoredByHTM-ITTitleVerification(driver);
        ReusableTests
                .testInstancesCurrentlyMonitoredByHTM-ITColumnNamesVerification(driver);
    }
    ...
    public static void htmItToWebPageHelpTextVerification(WebDriver driver) {
        ...
        Assert.assertEquals(managePageHTM-ITToWebPageTitle,
                "To place a HTM-IT Charts dashboard widget on your web page:");
        Assert.assertEquals(managePageHTM-ITToWebPageHelpText2,
