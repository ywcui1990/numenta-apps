...
CSV generated by htm_it_custom_metric_stress.py; outputs the new CSV to stdout.
...
def main(profileCsvPath, modelCountsCsvPath):
  ...
  :param modelCountsCsvPath: path to CSV file from htm_it_custom_metric_stress.py
  """
...
def _parseArgs():
  ...
  helpString = (
    ...
    "the CSV generated by htm_it_custom_metric_stress.py; outputs the new CSV to "
