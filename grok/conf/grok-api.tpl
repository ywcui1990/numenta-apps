...
http {
  ...
  server {
    ...
    # In the updater, maintenance.html does an ajax call to /grok/embed/charts
  ...
  server {
    ...
    rewrite ^/grok/$ /grok permanent;
    rewrite ^/grok/mobile /grok/complete permanent;
