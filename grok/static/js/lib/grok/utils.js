...
(function($) {
    ...
    GROKUI.utils.modalError = function(error) {
        ...
        if(message.match(regex.quota)) {
            ...
            title = 'Limit Reached';
            body = 'Sorry, Grok is limited to monitoring ' + limit + ' instances and AutoStacks on an AWS EC2 server of the current size.';
            message = 'Please upgrade to a bigger AWS EC2 instance type in order to <a href="http://www.numenta.com/assets/pdf/grok/resources/1.5/Upgrade-AWS-EC2-Instance-Size.pdf" target="_new">increase the monitoring capacity of Grok</a>.';
        }
