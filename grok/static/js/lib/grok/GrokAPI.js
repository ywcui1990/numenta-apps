 ...
 * @module
 * @requires jQuery
 * @see Grok REST API Documentation: products/grok/app/webservices/README.md
 */
...
(function() {
    ...
    /**
     * Deletes a Grok Custom Metric (uses metricName as in custom_api.py)
     * @method
     ...
     * @returns {Object} jqXHR object
     */
    GrokAPI.prototype.deleteGrokCustomMetric = function(metricName, callback) {
        var url = [
                this.opts.endPoint,
                this.CONST.ENDPOINTS.METRICS,
                this.CONST.METRICS.PATHS.CUSTOM,
     ...
     * @returns {Object} jqXHR object
     */
    GrokAPI.prototype.getAnnotations = function(opts, callback) {
        if(typeof opts === 'function') {
            callback = opts;
            opts = {};
        }
