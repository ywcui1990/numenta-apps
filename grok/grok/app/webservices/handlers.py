...
import grok.app
from grok.app.exceptions import AuthFailure
from grok.app.webservices.responses import UnauthorizedResponse
  ...
  def addServerHeader():
    ...
    version.
      ...
      Sample Server Header::
        ...
        Server: Grok 1.6.0
    """
    web.header("Server", "Grok %s" % __version__.__version__, True)
