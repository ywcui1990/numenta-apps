...
from grok.app.adapters.datasource.autostack.autostack_metric_adapter import (
  AutostackMetricAdapterBase)
from grok.app.aws import cloudwatch_utils
import grok.app.exceptions as app_exceptions
from grok.app.runtime.aggregator_instances import getAutostackInstances
from grok.app.runtime.aggregator_utils import getAWSCredentials, TimeRange



_MODULE_NAME = "grok.aggregator_metric_collection"
...
class EC2InstanceMetricGetter(object):
  ...
  # grok runtime names of those statistics
  _STATS_OF_INTEREST = {
    "Maximum": "max",
    "Minimum": "min"
  }
  ...
  def _createMetricStatisticsCollectionTasks(
    ...
    :param timeSlice: the time range of the metric data for which the statistics
        are to be gathered.
    :type timeSlice: grok.app.runtime.aggregator_utils.TimeRange
  ...
  def _updateInstanceCache(self, autostacks):
    ...
    :type autostacks: List of nametuple as returned by
      ...
      grok.app.repository.schema.autostack.  See also: AggregatorService.run()
    """
