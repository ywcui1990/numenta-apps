...
# ----------------------------------------------------------------------
"""
This module implements the Grok Aggregator service that is responsible for
...
from grok.app.runtime.aggregation import aggregate
...
def main(args):
  ...
  helpString = (
    "Usage: %prog\n"
    "This script runs the Grok Aggregator service.")
