...
def checkEC2Authorization(awsAccessKeyID, awsSecretAccessKey):
  ...
  :raises grok.app.exceptions.AuthFailure:
  :raises grok.app.exceptions.AWSPermissionsError:
  """
  ...
  try:
    ...
    if (e.error_code == "AuthFailure" or
      ...
      raise grok.app.exceptions.AuthFailure(e.message)
    raise grok.app.exceptions.AWSPermissionsError(
