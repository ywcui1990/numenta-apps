...
from grok.app.exceptions import MetricStatisticsNotReadyError
from grok.app.runtime import aggregation
from grok.app.runtime.aggregator_metric_collection import (InstanceMetricData,
                                                           MetricRecord)
...
class GetStatisticsTest(unittest.TestCase):
  ...
  @patch("grok.app.runtime.aggregation.repository")
  @patch("grok.app.runtime.aggregation.EC2InstanceMetricGetter")
  ...
  @patch("grok.app.runtime.aggregation.repository.engineFactory", autospec=True)
  @patch("grok.app.repository.getAutostackFromMetric", autospec=True)
  @patch("grok.app.runtime.aggregation.EC2InstanceMetricGetter", autospec=True)
