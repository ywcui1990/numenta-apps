...
public class ManageTest {
    ...
    static By MANAGE_PAGE_WEB_PAGE_SECTION_TITLE = By
            .xpath("//div[@class='grok-embed-form grok-panel well']/h3");
    static By MANAGE_PAGE_WIDTH_INPUT = By.xpath("//input[@id='domain']");
    static By MONITORED_ADDITIONAL_INSTANCES_BUTTON = By
            .xpath("//button[@data-toggle='dropdown']");
    static By MANAGE_ADD_GROK_TITLE = By
            .xpath("//div[@class='grok-embed-form grok-panel well']/h3");
    static By MANAGE_ADD_GROK_HELP_TEXT_TITLE = By
            .xpath("//div[@class='grok-embed-form grok-panel well']/p");
    /*
     * Each of MANAGE_ADD_GROK_HELP_TEXT_# / is one of the help text bullet
     * points present under "Add Grok to Any Web Page" section in the /grok
     * page.
     */
    static By MANAGE_ADD_GROK_HELP_TEXT_1 = By
            .xpath("//div[@class='grok-embed-form grok-panel well']/ul/li[1]");
    static By MANAGE_ADD_GROK_HELP_TEXT_2 = By
            .xpath("//div[@class='grok-embed-form grok-panel well']/ul/li[2]");
    ...
    static By NAVIGATE_TO_AUTOSTACK_PAGE = By
            .xpath("//a[@href='/grok/instances/autostack']");
    static By NAVIGATE_TO_SBNT_PAGE = By
            .xpath("//a[@href='/grok/instances/auto']");
    ...
    public static void manageInstancesCurrentlyMonitoredByGrokSectionVerification(
            WebDriver driver) {
        ReusableTests
                .testInstancesCurrentlyMonitoredByGrokTitleVerification(driver);
        ReusableTests
                .testInstancesCurrentlyMonitoredByGrokColumnNamesVerification(driver);
    }
    ...
    public static void addgrokToWebPageTitleVerification(WebDriver driver) {
        String managePageGrokToWebPageTitle = TestUtilities.waitGetText(
                MANAGE_ADD_GROK_TITLE, driver, WAIT_TIME);
        Assert.assertEquals(managePageGrokToWebPageTitle,
                "Add Grok to Any Web Page");
    }

    public static void grokToWebPageHelpTextVerification(WebDriver driver) {
        String managePageGrokToWebPageTitle = TestUtilities.waitGetText(
                MANAGE_ADD_GROK_HELP_TEXT_TITLE, driver, WAIT_TIME);
        /*
         * 1st bullet point Add Grok to Any Web Page section
         * "i.e. Enter the hostname where you will embed the widget, and the width and height."
         */
        String managePageGrokToWebPageHelpText1 = TestUtilities.waitGetText(
                MANAGE_ADD_GROK_HELP_TEXT_1, driver, WAIT_TIME);
        /*
         * 2st bullet point Add Grok to Any Web Page section
         * "i.e. Copy the Embed Code, and place it in the HTML source code of your website."
         */
        String managePageGrokToWebPageHelpText2 = TestUtilities.waitGetText(
                MANAGE_ADD_GROK_HELP_TEXT_2, driver, WAIT_TIME);
        Assert.assertEquals(managePageGrokToWebPageHelpText1,
                "Enter the hostname where you will embed the widget, "
                        + "and the width and height.");
        Assert.assertEquals(managePageGrokToWebPageTitle,
                "To place a Grok Charts dashboard widget on your web page:");
        Assert.assertEquals(managePageGrokToWebPageHelpText2,
                "Copy the Embed Code, and place it in the HTML "
                        + "source code of your website.");
    }

    public static void grokToWebPageLabelVerification(WebDriver driver) {
