...
import com.grok.utils.SystemUnderTest;
...
public class AdvancedUserGrok {
    ...
    public void installMobileAppPageValidation() throws Exception {
        InstallGrokMobileAppTest.installGrokMobileAppTitleVerification(driver);
        InstallGrokMobileAppTest.installGrokMobileAppRequirementSection(driver);
        InstallGrokMobileAppTest.installGrokMobileAppStepsVerification(driver);
        InstallGrokMobileAppTest
                .installGrokMobileAppCompareRequirementSectionAndSetupServerURL(driver);
        InstallGrokMobileAppTest.installGrokAppFooter(driver);
        InstallGrokMobileAppTest.installGrokAppHeader(driver);
        InstallGrokMobileAppTest.installGrokMobileAppSetUpProgressBarVerification(driver);
        InstallGrokMobileAppTest
                .installGrokMobileAppManageMonitoredInstancesButton(driver);
    }
    ...
    public void managePageValidation() throws Exception {
        ...
        ManageTest
                .manageInstancesCurrentlyMonitoredByGrokSectionVerification(driver);
        ManageTest.monitorAdditionalInstancesDropDownVerification(driver);
        ManageTest.addgrokToWebPageTitleVerification(driver);
        ManageTest.grokToWebPageHelpTextVerification(driver);
