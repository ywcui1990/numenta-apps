...
public class AutoStackPage {
    ...
    static By NAVIGATE_TO_BROWSE_PAGE = By
            .xpath("//a[@href='/grok/instances/manual']");
    ...
    public static void autoStackPageHelpTextVerification(WebDriver driver) {
        ...
        Assert.assertEquals(
                ...
                "Create a group of logically related EC2 instances that will be monitored as a single \"Instance\" within Grok");
