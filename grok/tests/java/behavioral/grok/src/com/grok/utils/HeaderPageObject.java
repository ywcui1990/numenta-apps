...
public class HeaderPageObject {
    ...
    static By GROK_LOGO = By.xpath("//a[@class='navbar-brand']");
    static By HELP_LOGO = By.xpath("//li[@class='help']");
    static By MANAGE_TAB = By.xpath("//li/a[@href='/grok']");
    static By CHARTS = By.xpath("//li/a[@href='/grok/embed/charts']");
    static By SETUP_DROPDOWN = By.xpath("//li/a[@href='/grok/welcome']");

    public HeaderPageObject(WebDriver driver) {
        this.driver = driver;
    }

    public String grokLogo() {
        return driver.findElement(GROK_LOGO).getText();
