...
def main():
  ...
  """
  # Initial cleanup.
  # os.system("rm -rf build/ dist/ nupic/")

  # Install nupic locally and include it in the library.zip generated by 
  # cx_freeze.

  modelRunnerDir = os.path.dirname(os.path.realpath(__file__))
  # nupicInstall = "pip install --target %s nupic" % os.path.join(
  # modelRunnerDir,
  #                                                              "nupic")
  # print "Installing nupic: %s" % nupicInstall
  ...
  # final cleanup
  #os.system("rm -rf %s" % os.path.join(modelRunnerDir, "nupic"))
