...
CSV generated by htm-it_custom_metric_stress.py; outputs the new CSV to stdout.
...
def main(profileCsvPath, modelCountsCsvPath):
  ...
  :param modelCountsCsvPath: path to CSV file from htm-it_custom_metric_stress.py
  """
...
def _parseArgs():
  ...
  helpString = (
    ...
    "the CSV generated by htm-it_custom_metric_stress.py; outputs the new CSV to "
